...
<html lang="en">
  <head>
    ...
    <title>
     Real Estate &mdash; Spring Boot Project
    </title>
  </head>
  <body>
              ...
              <div class="property-slider">
                <div class="property-item">
                  ...
                  <div class="property-content">
                    <div class="price mb-2"><span>Rs.1,291,000</span></div>
                    <div>
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                ...
                <h3 class="h5 text-primary mb-4">Sumit Gore</h3>
                <blockquote>
                  <p>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="h-100 person">
              <img
                src="images/person_1-m.jpg"
                alt="Image"
                class="img-fluid"
              />

              <div class="person-contents">
                <h2 class="mb-0"><a href="#">Sumit Gore</a></h2>
